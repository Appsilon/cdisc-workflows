...
N_SUBJECTS = int(os.environ.get("SUBJECT_COUNT", "40"))
STUDYID = "D6470C00005"
...
cohort_1_n = round(N_SUBJECTS * 0.6)
remaining_subjects = N_SUBJECTS - cohort_1_n
cohort_2_n = remaining_subjects // 2
cohort_3_n = remaining_subjects - cohort_2_n
COHORTS = [("Cohort 1", cohort_1_n, ("AZD9567 72 mg", "Prednisolone 40 mg")),
           ("Cohort 2", cohort_2_n, ("AZD9567 40 mg", "Prednisolone 20 mg")),
           ("Cohort 3", cohort_3_n, ("Placebo", "Prednisolone 5 mg"))]
